...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/05 07:44:02 by lulee             #+#    #+#             */
/*   Updated: 2020/03/05 09:13:12 by lulee            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	char							ft_letter(t_param *param,
		unsigned char num)
{
	int	coef;
...
static	unsigned	int					final_part(t_param *param,
		unsigned long long int var, unsigned int count)
{
	unsigned	char	tmp;
...
unsigned	int							print_num_xx(t_param *param,
